...
ADAx.Appendix = function() {
    ...
    apxTextsA[i++].textContent = "Triplets of 5 Characters - little"; //***
    apxTextsA[i++].textContent = "Red: Nietzsche - Beyond..";           //***
    apxTextsA[i++].textContent = "Blue:..random characters..";       //***
